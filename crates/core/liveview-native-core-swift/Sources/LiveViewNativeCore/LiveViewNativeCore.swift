...
public struct FfiConverterTypeLiveSocketError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> LiveSocketError {
        ...
        case 13: return .CsfrTokenMissing
        case 14: return .PhoenixIdMissing
        case 15: return try .ConnectionError(
                FfiConverterString.read(from: &buf)
            )
        case 16: return .PhoenixSessionMissing
        case 17: return .PhoenixStaticMissing
        case 18: return .PhoenixMainMissing
        case 19: return .NoHostInUrl
        case 20: return .NoUploadToken
        case 21: return .NoLiveReloadUrl
        case 22: return try .SchemeNotSupported(
                scheme: FfiConverterString.read(from: &buf)
            )
        case 23: return try .Upload(
                error: FfiConverterTypeUploadError.read(from: &buf)
            )
        case 24: return .NoDocumentInJoinPayload
        case 25: return try .DocumentMerge(
                error: FfiConverterTypeMergeError.read(from: &buf)
            )
        case 26: return try .DocumentRender(
                error: FfiConverterTypeRenderError.read(from: &buf)
            )
        case 27: return .NoInputRefInDocument
        case 28: return try .Serde(
                error: FfiConverterString.read(from: &buf)
            )
        case 29: return try .Events(
                error: FfiConverterString.read(from: &buf)
            )
        default: throw UniffiInternalError.unexpectedEnumCase
        }
