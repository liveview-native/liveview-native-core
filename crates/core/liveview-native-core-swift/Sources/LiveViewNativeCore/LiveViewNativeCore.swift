...
public protocol LiveSocketProtocol: AnyObject {
    func back(_ info: Data?) async throws -> UInt64
    ...
    func forward(_ info: Data?) async throws -> UInt64
    ...
    func reload(_ info: Data?) async throws -> UInt64
    ...
    func traverseTo(_ id: UInt64, _ info: Data?) async throws -> UInt64
}
    ...
    LiveSocketProtocol
{
    ...
    open func back(_ info: Data?) async throws -> UInt64 {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
    ...
    open func forward(_ info: Data?) async throws -> UInt64 {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
    ...
    open func reload(_ info: Data?) async throws -> UInt64 {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
    ...
    open func traverseTo(_ id: UInt64, _ info: Data?) async throws -> UInt64 {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_liveview_native_core_fn_method_livesocket_traverse_to(
                        self.uniffiClonePointer(),
                        FfiConverterUInt64.lower(id), FfiConverterOptionData.lower(info)
                    )
                },
                pollFunc: ffi_liveview_native_core_rust_future_poll_u64,
                completeFunc: ffi_liveview_native_core_rust_future_complete_u64,
...
public struct FfiConverterTypeLiveSocketError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> LiveSocketError {
        ...
        case 9: return try .Phoenix(
                error: FfiConverterString.read(from: &buf)
            )
        case 10: return try .Request(
                error: FfiConverterString.read(from: &buf)
            )
        case 11: return try .Parse(
                error: FfiConverterTypeParseError.read(from: &buf)
            )
        case 12: return try .JsonDeserialization(
                error: FfiConverterString.read(from: &buf)
            )
        case 13: return try .ChannelStatusUserError(
                error: FfiConverterString.read(from: &buf)
            )
        case 14: return .CsfrTokenMissing
        case 15: return .PhoenixIdMissing
        case 16: return try .ConnectionError(
                FfiConverterString.read(from: &buf)
            )
        case 17: return .PhoenixSessionMissing
        case 18: return .PhoenixStaticMissing
        case 19: return .PhoenixMainMissing
        case 20: return .NoHostInUrl
        case 21: return .NoUploadToken
        case 22: return .NoLiveReloadUrl
        case 23: return try .SchemeNotSupported(
                scheme: FfiConverterString.read(from: &buf)
            )
        case 24: return try .Upload(
                error: FfiConverterTypeUploadError.read(from: &buf)
            )
        case 25: return .NoDocumentInJoinPayload
        case 26: return try .DocumentMerge(
                error: FfiConverterTypeMergeError.read(from: &buf)
            )
        case 27: return try .DocumentRender(
                error: FfiConverterTypeRenderError.read(from: &buf)
            )
        case 28: return .NoInputRefInDocument
        case 29: return try .Serde(
                error: FfiConverterString.read(from: &buf)
            )
        case 30: return try .Events(
                error: FfiConverterString.read(from: &buf)
            )
        default: throw UniffiInternalError.unexpectedEnumCase
        }
...
private var initializationResult: InitializationResult = {
    ...
    if uniffi_liveview_native_core_checksum_method_livesocket_back() != 1612 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_liveview_native_core_checksum_method_livesocket_forward() != 50776 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_liveview_native_core_checksum_method_livesocket_navigate() != 303 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_liveview_native_core_checksum_method_livesocket_reload() != 25122 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_liveview_native_core_checksum_method_livesocket_traverse_to() != 45994 {
        return InitializationResult.apiChecksumMismatch
    }
