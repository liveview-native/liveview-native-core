...
public protocol LiveViewClientProtocol: AnyObject {
     ...
     */
    func back(_ opts: NavActionOptions) async throws -> UInt64
     ...
     * with a live_channel.
     */
    func channel() -> LiveViewClientChannel
     ...
     */
    func forward(_ opts: NavActionOptions) async throws -> UInt64
     ...
     */
    func liveReloadChannel() throws -> LiveChannel?

    /**
     * Navigate to `url` with behavior and metadata specified in `opts`.
     */
    func navigate(_ url: String, _ opts: NavOptions) async throws -> UInt64
     ...
     */
    func reload(_ opts: NavActionOptions) async throws -> UInt64
     ...
     */
    func status() throws -> SocketStatus
     ...
     */
    func traverseTo(_ id: UInt64, _ opts: NavActionOptions) async throws -> UInt64
    ...
    LiveViewClientProtocol
{
     ...
     * This function fails if there are no items in history.
     */
    open func back(_ opts: NavActionOptions) async throws -> UInt64 {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_liveview_native_core_fn_method_liveviewclient_back(
                        self.uniffiClonePointer(),
                        FfiConverterTypeNavActionOptions.lower(opts)
                    )
                },
                pollFunc: ffi_liveview_native_core_rust_future_poll_u64,
                completeFunc: ffi_liveview_native_core_rust_future_complete_u64,
                freeFunc: ffi_liveview_native_core_rust_future_free_u64,
     ...
     * with a live_channel.
     */
    open func channel() -> LiveViewClientChannel {
        return try! FfiConverterTypeLiveViewClientChannel.lift(try! rustCall {
            uniffi_liveview_native_core_fn_method_liveviewclient_channel(self.uniffiClonePointer(), $0)
        })
    }
     ...
     * This function fails if there are no items ahead of this one in history.
     */
    open func forward(_ opts: NavActionOptions) async throws -> UInt64 {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_liveview_native_core_fn_method_liveviewclient_forward(
                        self.uniffiClonePointer(),
                        FfiConverterTypeNavActionOptions.lower(opts)
                    )
                },
     ...
     * `asset_change` events on this for any reason - this API is intended to be deprecated.
     */
    open func liveReloadChannel() throws -> LiveChannel? {
        return try FfiConverterOptionTypeLiveChannel.lift(rustCallWithError(FfiConverterTypeLiveSocketError.lift) {
            uniffi_liveview_native_core_fn_method_liveviewclient_live_reload_channel(self.uniffiClonePointer(), $0)
        })
    }
     ...
     * Navigate to `url` with behavior and metadata specified in `opts`.
     */
    open func navigate(_ url: String, _ opts: NavOptions) async throws -> UInt64 {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_liveview_native_core_fn_method_liveviewclient_navigate(
                        self.uniffiClonePointer(),
                        FfiConverterString.lower(url), FfiConverterTypeNavOptions.lower(opts)
                    )
                },
                pollFunc: ffi_liveview_native_core_rust_future_poll_u64,
                completeFunc: ffi_liveview_native_core_rust_future_complete_u64,
     ...
     * event data with the bytes in `info`
     */
    open func reload(_ opts: NavActionOptions) async throws -> UInt64 {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_liveview_native_core_fn_method_liveviewclient_reload(
                        self.uniffiClonePointer(),
                        FfiConverterTypeNavActionOptions.lower(opts)
                    )
                },
     ...
     * Returns the current socket status
     */
    open func status() throws -> SocketStatus {
        return try FfiConverterTypeSocketStatus_lift(rustCallWithError(FfiConverterTypeLiveSocketError.lift) {
     ...
     * This function fails if the entry has been removed.
     */
    open func traverseTo(_ id: UInt64, _ opts: NavActionOptions) async throws -> UInt64 {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_liveview_native_core_fn_method_liveviewclient_traverse_to(
                        self.uniffiClonePointer(),
                        FfiConverterUInt64.lower(id), FfiConverterTypeNavActionOptions.lower(opts)
                    )
                },
                pollFunc: ffi_liveview_native_core_rust_future_poll_u64,
                completeFunc: ffi_liveview_native_core_rust_future_complete_u64,
 ...
 */
public protocol LiveViewClientChannelProtocol: AnyObject {
    /**
 ...
 * send messages through the current websocket.
 */
open class LiveViewClientChannel:
    LiveViewClientChannelProtocol
{
    fileprivate let pointer: UnsafeMutableRawPointer!
    ...
    #endif
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_liveview_native_core_fn_clone_liveviewclientchannel(self.pointer, $0) }
    }
    ...
    deinit {
        ...
        try! rustCall { uniffi_liveview_native_core_fn_free_liveviewclientchannel(pointer, $0) }
    }
    ...
    open func call(_ eventName: String, _ payload: Payload) async throws -> Payload {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_liveview_native_core_fn_method_liveviewclientchannel_call(
                        self.uniffiClonePointer(),
    ...
    open func cast(_ eventName: String, _ payload: Payload) async {
        return
            try! await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_liveview_native_core_fn_method_liveviewclientchannel_cast(
                        self.uniffiClonePointer(),
                        FfiConverterString.lower(eventName), FfiConverterTypePayload_lower(payload)
                    )
                },
    ...
    @_documentation(visibility: private)
#endif
public struct FfiConverterTypeLiveViewClientChannel: FfiConverter {
    typealias FfiType = UnsafeMutableRawPointer
    typealias SwiftType = LiveViewClientChannel

    public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> LiveViewClientChannel {
        return LiveViewClientChannel(unsafeFromRawPointer: pointer)
    }

    public static func lower(_ value: LiveViewClientChannel) -> UnsafeMutableRawPointer {
        return value.uniffiClonePointer()
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> LiveViewClientChannel {
        let v: UInt64 = try readInt(&buf)
        // The Rust code won't compile if a pointer won't fit in a UInt64.
        // We have to go via `UInt` because that's the thing that's the size of a pointer.
        let ptr = UnsafeMutableRawPointer(bitPattern: UInt(truncatingIfNeeded: v))
    ...
    public static func write(_ value: LiveViewClientChannel, into buf: inout [UInt8]) {
        // This fiddling is because `Int` is the thing that's the same size as a pointer.
        // The Rust code won't compile if a pointer won't fit in a `UInt64`.
        writeInt(&buf, UInt64(bitPattern: Int64(Int(bitPattern: lower(value)))))
    }
    ...
    @_documentation(visibility: private)
#endif
public func FfiConverterTypeLiveViewClientChannel_lift(_ pointer: UnsafeMutableRawPointer) throws -> LiveViewClientChannel {
    return try FfiConverterTypeLiveViewClientChannel.lift(pointer)
}

#if swift(>=5.8)
    @_documentation(visibility: private)
#endif
public func FfiConverterTypeLiveViewClientChannel_lower(_ value: LiveViewClientChannel) -> UnsafeMutableRawPointer {
    return FfiConverterTypeLiveViewClientChannel.lower(value)
}
...
public enum Issuer {
    ...
    @_documentation(visibility: private)
#endif
public struct FfiConverterTypeIssuer: FfiConverterRustBuffer {
    typealias SwiftType = Issuer

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Issuer {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return try .external(FfiConverterTypeNavigationCall.read(from: &buf)
            )

        case 2: return .liveReload

        case 3: return .redirect

        case 4: return .liveRedirect

        case 5: return .assetChange

        case 6: return try .other(FfiConverterString.read(from: &buf)
            )
    ...
    public static func write(_ value: Issuer, into buf: inout [UInt8]) {
        switch value {
        case let .external(v1):
            writeInt(&buf, Int32(1))
            FfiConverterTypeNavigationCall.write(v1, into: &buf)
    ...
    @_documentation(visibility: private)
#endif
public func FfiConverterTypeIssuer_lift(_ buf: RustBuffer) throws -> Issuer {
    return try FfiConverterTypeIssuer.lift(buf)
}

#if swift(>=5.8)
    @_documentation(visibility: private)
#endif
public func FfiConverterTypeIssuer_lower(_ value: Issuer) -> RustBuffer {
    return FfiConverterTypeIssuer.lower(value)
}

extension Issuer: Equatable, Hashable {}
...
public struct FfiConverterTypeLiveSocketError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> LiveSocketError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return try .Call(
                error: FfiConverterString.read(from: &buf)
            )
        case 2: return try .Cast(
                error: FfiConverterString.read(from: &buf)
            )
        case 3: return .WouldLock
        case 4: return try .FormData(
                error: FfiConverterString.read(from: &buf)
            )
        case 5: return .LockPoisoned
        case 6: return .DisconnectionError
        case 7: return .NavigationImpossible
        case 8: return .PayloadNotJson
        case 9: return try .MimeType(
                error: FfiConverterString.read(from: &buf)
            )
        case 10: return try .InvalidHeader(
                error: FfiConverterString.read(from: &buf)
            )
        case 11: return try .InvalidMethod(
                error: FfiConverterString.read(from: &buf)
            )
        case 12: return try .JoinRejection(
                error: FfiConverterTypePayload.read(from: &buf)
            )
        case 13: return try .Phoenix(
                error: FfiConverterString.read(from: &buf)
            )
        case 14: return try .Request(
                error: FfiConverterString.read(from: &buf)
            )
        case 15: return try .Parse(
                error: FfiConverterTypeParseError.read(from: &buf)
            )
        case 16: return try .JsonDeserialization(
                error: FfiConverterString.read(from: &buf)
            )
        case 17: return try .ChannelStatusUserError(
                error: FfiConverterString.read(from: &buf)
            )
        case 18: return .CsrfTokenMissing
        case 19: return .PhoenixIdMissing
        case 20: return try .ConnectionError(
                FfiConverterTypeConnectionError.read(from: &buf)
            )
        case 21: return .PhoenixSessionMissing
        case 22: return .PhoenixStaticMissing
        case 23: return .PhoenixMainMissing
        case 24: return .NoHostInUrl
        case 25: return .NoUploadToken
        case 26: return .NoLiveReloadUrl
        case 27: return try .SchemeNotSupported(
                scheme: FfiConverterString.read(from: &buf)
            )
        case 28: return try .Upload(
                error: FfiConverterTypeUploadError.read(from: &buf)
            )
        case 29: return .NoDocumentInJoinPayload
        case 30: return try .DocumentMerge(
                error: FfiConverterTypeMergeError.read(from: &buf)
            )
        case 31: return try .DocumentRender(
                error: FfiConverterTypeRenderError.read(from: &buf)
            )
        case 32: return .NoInputRefInDocument
        case 33: return try .Serde(
                error: FfiConverterString.read(from: &buf)
            )
        case 34: return try .Events(
                error: FfiConverterString.read(from: &buf)
            )
        default: throw UniffiInternalError.unexpectedEnumCase
        }
...
public enum NavigationCall {
    ...
    @_documentation(visibility: private)
#endif
public struct FfiConverterTypeNavigationCall: FfiConverterRustBuffer {
    typealias SwiftType = NavigationCall

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> NavigationCall {
        let variant: Int32 = try readInt(&buf)
        switch variant {
    ...
    public static func write(_ value: NavigationCall, into buf: inout [UInt8]) {
        switch value {
        case .initialization:
            writeInt(&buf, Int32(1))
    ...
    @_documentation(visibility: private)
#endif
public func FfiConverterTypeNavigationCall_lift(_ buf: RustBuffer) throws -> NavigationCall {
    return try FfiConverterTypeNavigationCall.lift(buf)
}

#if swift(>=5.8)
    @_documentation(visibility: private)
#endif
public func FfiConverterTypeNavigationCall_lower(_ value: NavigationCall) -> RustBuffer {
    return FfiConverterTypeNavigationCall.lower(value)
}

extension NavigationCall: Equatable, Hashable {}
...
public protocol NetworkEventHandler: AnyObject {
     ...
     */
    func handleEvent(_ event: EventPayload)

    /**
     * Called when the current LiveChannel status changes.
     */
    func handleChannelStatusChange(_ event: LiveChannelStatus)

    /**
     * Called when the LiveSocket status changes.
     */
    func handleSocketStatusChange(_ event: SocketStatus)
     ...
     */
    func handleViewReloaded(_ issuer: Issuer, _ newDocument: Document, _ newChannel: LiveChannel, _ currentSocket: Socket, _ socketIsNew: Bool)
}
    ...
    static var vtable: UniffiVTableCallbackInterfaceNetworkEventHandler = .init(
        ...
        handleChannelStatusChange: { (
            ...
            let makeCall = {
                ...
                return try uniffiObj.handleChannelStatusChange(
                    FfiConverterTypeLiveChannelStatus.lift(event)
                )
            }
        ...
        handleSocketStatusChange: { (
            ...
            let makeCall = {
                ...
                return try uniffiObj.handleSocketStatusChange(
                    FfiConverterTypeSocketStatus_lift(event)
                )
            }
        ...
        handleViewReloaded: { (
            uniffiHandle: UInt64,
            issuer: RustBuffer,
            newDocument: UnsafeMutableRawPointer,
            newChannel: UnsafeMutableRawPointer,
            currentSocket: UnsafeMutableRawPointer,
            socketIsNew: Int8,
            _: UnsafeMutableRawPointer,
            uniffiCallStatus: UnsafeMutablePointer<RustCallStatus>
        ) in
            let makeCall = {
                ...
                return try uniffiObj.handleViewReloaded(
                    FfiConverterTypeIssuer.lift(issuer),
                    FfiConverterTypeDocument.lift(newDocument),
                    FfiConverterTypeLiveChannel.lift(newChannel),
                    FfiConverterTypeSocket_lift(currentSocket),
                    FfiConverterBool.lift(socketIsNew)
                )
            }
...
private var initializationResult: InitializationResult = {
    ...
    if uniffi_liveview_native_core_checksum_method_liveviewclient_back() != 65358 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_liveview_native_core_checksum_method_liveviewclient_channel() != 30993 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_liveview_native_core_checksum_method_liveviewclient_forward() != 58891 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_liveview_native_core_checksum_method_liveviewclient_get_entries() != 469 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_liveview_native_core_checksum_method_liveviewclient_get_phx_upload_id() != 58222 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_liveview_native_core_checksum_method_liveviewclient_live_reload_channel() != 23406 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_liveview_native_core_checksum_method_liveviewclient_navigate() != 17142 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_liveview_native_core_checksum_method_liveviewclient_reload() != 12479 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_liveview_native_core_checksum_method_liveviewclient_set_log_level() != 39975 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_liveview_native_core_checksum_method_liveviewclient_status() != 52517 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_liveview_native_core_checksum_method_liveviewclient_style_urls() != 17620 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_liveview_native_core_checksum_method_liveviewclient_traverse_to() != 32714 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_liveview_native_core_checksum_method_liveviewclientchannel_call() != 31362 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_liveview_native_core_checksum_method_liveviewclientchannel_cast() != 46530 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_liveview_native_core_checksum_method_networkeventhandler_handle_event() != 21363 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_liveview_native_core_checksum_method_networkeventhandler_handle_channel_status_change() != 29684 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_liveview_native_core_checksum_method_networkeventhandler_handle_socket_status_change() != 10934 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_liveview_native_core_checksum_method_networkeventhandler_handle_view_reloaded() != 47573 {
        return InitializationResult.apiChecksumMismatch
    }
