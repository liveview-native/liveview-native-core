    ...
    LiveSocketProtocol
{
    ...
    public convenience init(_ url: String, _ timeout: TimeInterval) throws {
        let pointer =
            try rustCallWithError(FfiConverterTypeLiveSocketError.lift) {
                uniffi_liveview_native_core_fn_constructor_livesocket_new(
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_liveview_native_core_checksum_constructor_livesocket_new() != 40076 {
        return InitializationResult.apiChecksumMismatch
    }
