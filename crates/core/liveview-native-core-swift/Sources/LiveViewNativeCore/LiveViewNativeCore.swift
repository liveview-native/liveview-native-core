...
public protocol LiveSocketProtocol: AnyObject {
    ...
    func joinLiveviewChannel(_ joinParams: [String: Json]?) async throws -> LiveChannel
    ...
    LiveSocketProtocol
{
    ...
    public convenience init(_ url: String, _ timeout: TimeInterval, _ format: String) async throws {
        let pointer =
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_liveview_native_core_fn_constructor_livesocket_new(FfiConverterString.lower(url), FfiConverterDuration.lower(timeout), FfiConverterString.lower(format))
                },
    ...
    public static func connect(_ url: String, _ timeout: TimeInterval, _ format: String) async throws -> LiveSocket {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_liveview_native_core_fn_constructor_livesocket_connect(FfiConverterString.lower(url), FfiConverterDuration.lower(timeout), FfiConverterString.lower(format))
                },
                pollFunc: ffi_liveview_native_core_rust_future_poll_pointer,
                completeFunc: ffi_liveview_native_core_rust_future_complete_pointer,
                freeFunc: ffi_liveview_native_core_rust_future_free_pointer,
    ...
    open func joinLiveviewChannel(_ joinParams: [String: Json]?) async throws -> LiveChannel {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_liveview_native_core_fn_method_livesocket_join_liveview_channel(
                        self.uniffiClonePointer(),
                        FfiConverterOptionDictionaryStringTypeJSON.lower(joinParams)
                    )
                },
                pollFunc: ffi_liveview_native_core_rust_future_poll_pointer,
                completeFunc: ffi_liveview_native_core_rust_future_complete_pointer,
...
private var initializationResult: InitializationResult = {
    ...
    if uniffi_liveview_native_core_checksum_method_livesocket_join_liveview_channel() != 16933 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_liveview_native_core_checksum_constructor_livesocket_connect() != 10911 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_liveview_native_core_checksum_constructor_livesocket_new() != 49338 {
        return InitializationResult.apiChecksumMismatch
    }
