...
public protocol LiveSocketProtocol: AnyObject {
    func back(_ oldChannel: LiveChannel?, _ info: Data?) async throws -> LiveChannel
    ...
    func forward(_ oldChannel: LiveChannel?, _ info: Data?) async throws -> LiveChannel
    ...
    func navigate(_ url: String, _ oldChannel: LiveChannel?, _ opts: NavOptions) async throws -> LiveChannel

    func reload(_ oldChannel: LiveChannel, _ info: Data?) async throws -> LiveChannel
    ...
    func traverseTo(_ id: UInt64, _ oldChannel: LiveChannel?, _ info: Data?) async throws -> LiveChannel
}
    ...
    LiveSocketProtocol
{
    ...
    open func back(_ oldChannel: LiveChannel?, _ info: Data?) async throws -> LiveChannel {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_liveview_native_core_fn_method_livesocket_back(
                        self.uniffiClonePointer(),
                        FfiConverterOptionTypeLiveChannel.lower(oldChannel), FfiConverterOptionData.lower(info)
                    )
                },
                pollFunc: ffi_liveview_native_core_rust_future_poll_pointer,
                completeFunc: ffi_liveview_native_core_rust_future_complete_pointer,
    ...
    open func forward(_ oldChannel: LiveChannel?, _ info: Data?) async throws -> LiveChannel {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
    ...
    open func navigate(_ url: String, _ oldChannel: LiveChannel?, _ opts: NavOptions) async throws -> LiveChannel {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_liveview_native_core_fn_method_livesocket_navigate(
                        self.uniffiClonePointer(),
                        FfiConverterString.lower(url), FfiConverterOptionTypeLiveChannel.lower(oldChannel), FfiConverterTypeNavOptions.lower(opts)
                    )
                },
                pollFunc: ffi_liveview_native_core_rust_future_poll_pointer,
                completeFunc: ffi_liveview_native_core_rust_future_complete_pointer,
    ...
    open func reload(_ oldChannel: LiveChannel, _ info: Data?) async throws -> LiveChannel {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_liveview_native_core_fn_method_livesocket_reload(
                        self.uniffiClonePointer(),
                        FfiConverterTypeLiveChannel.lower(oldChannel), FfiConverterOptionData.lower(info)
                    )
                },
                pollFunc: ffi_liveview_native_core_rust_future_poll_pointer,
                completeFunc: ffi_liveview_native_core_rust_future_complete_pointer,
    ...
    open func traverseTo(_ id: UInt64, _ oldChannel: LiveChannel?, _ info: Data?) async throws -> LiveChannel {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_liveview_native_core_fn_method_livesocket_traverse_to(
                        self.uniffiClonePointer(),
                        FfiConverterUInt64.lower(id), FfiConverterOptionTypeLiveChannel.lower(oldChannel), FfiConverterOptionData.lower(info)
                    )
                },
                pollFunc: ffi_liveview_native_core_rust_future_poll_pointer,
                completeFunc: ffi_liveview_native_core_rust_future_complete_pointer,
...
public struct NavOptions {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(action: NavAction? = nil, extraEventInfo: Data? = nil, state: Data? = nil) {
        self.action = action
...
public struct FfiConverterTypeLiveSocketError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> LiveSocketError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return .WouldLock
        case 2: return .LockPoisoned
        case 3: return .DisconnectionError
        case 4: return .NavigationImpossible
        case 5: return .PayloadNotJson
        case 6: return try .MimeType(
                error: FfiConverterString.read(from: &buf)
            )
        case 7: return try .InvalidHeader(
                error: FfiConverterString.read(from: &buf)
            )
        case 8: return try .InvalidMethod(
                error: FfiConverterString.read(from: &buf)
            )
        case 9: return try .JoinRejection(
                error: FfiConverterTypePayload.read(from: &buf)
            )
        case 10: return try .Phoenix(
                error: FfiConverterString.read(from: &buf)
            )
        case 11: return try .Request(
                error: FfiConverterString.read(from: &buf)
            )
        case 12: return try .Parse(
                error: FfiConverterTypeParseError.read(from: &buf)
            )
        case 13: return try .JsonDeserialization(
                error: FfiConverterString.read(from: &buf)
            )
        case 14: return try .ChannelStatusUserError(
                error: FfiConverterString.read(from: &buf)
            )
        case 15: return .CsfrTokenMissing
        case 16: return .PhoenixIdMissing
        case 17: return try .ConnectionError(
                FfiConverterString.read(from: &buf)
            )
        case 18: return .PhoenixSessionMissing
        case 19: return .PhoenixStaticMissing
        case 20: return .PhoenixMainMissing
        case 21: return .NoHostInUrl
        case 22: return .NoUploadToken
        case 23: return .NoLiveReloadUrl
        case 24: return try .SchemeNotSupported(
                scheme: FfiConverterString.read(from: &buf)
            )
        case 25: return try .Upload(
                error: FfiConverterTypeUploadError.read(from: &buf)
            )
        case 26: return .NoDocumentInJoinPayload
        case 27: return try .DocumentMerge(
                error: FfiConverterTypeMergeError.read(from: &buf)
            )
        case 28: return try .DocumentRender(
                error: FfiConverterTypeRenderError.read(from: &buf)
            )
        case 29: return .NoInputRefInDocument
        case 30: return try .Serde(
                error: FfiConverterString.read(from: &buf)
            )
        case 31: return try .Events(
                error: FfiConverterString.read(from: &buf)
            )
        default: throw UniffiInternalError.unexpectedEnumCase
        }
...
private enum UniffiCallbackInterfaceDocumentChangeHandler {
    ...
    static var vtable: UniffiVTableCallbackInterfaceDocumentChangeHandler = .init(
        ...
        handleChannelStatus: { (
            uniffiHandle: UInt64,
            channelStatus: RustBuffer,
            uniffiOutReturn: UnsafeMutablePointer<RustBuffer>,
            uniffiCallStatus: UnsafeMutablePointer<RustCallStatus>
        ) in
            let makeCall = {
                () throws -> ControlFlow in
                guard let uniffiObj = try? FfiConverterCallbackInterfaceDocumentChangeHandler.handleMap.get(handle: uniffiHandle) else {
                    throw UniffiInternalError.unexpectedStaleHandle
                }
                return try uniffiObj.handleChannelStatus(
                    FfiConverterTypeLiveChannelStatus.lift(channelStatus)
                )
            }

            let writeReturn = { uniffiOutReturn.pointee = FfiConverterTypeControlFlow.lower($0) }
            uniffiTraitInterfaceCall(
                callStatus: uniffiCallStatus,
                makeCall: makeCall,
                writeReturn: writeReturn
...
private var initializationResult: InitializationResult = {
    ...
    if uniffi_liveview_native_core_checksum_method_livesocket_back() != 26683 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_liveview_native_core_checksum_method_livesocket_forward() != 332 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_liveview_native_core_checksum_method_livesocket_navigate() != 22269 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_liveview_native_core_checksum_method_livesocket_reload() != 21479 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_liveview_native_core_checksum_method_livesocket_timeout() != 28451 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_liveview_native_core_checksum_method_livesocket_traverse_to() != 41571 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_liveview_native_core_checksum_method_documentchangehandler_handle_channel_status() != 31717 {
        return InitializationResult.apiChecksumMismatch
    }
