...
public struct FfiConverterTypeCapacityError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> CapacityError {
        ...
        case 2: return try .messageTooLong(size: FfiConverterUInt64.read(from: &buf), maxSize: FfiConverterUInt64.read(from: &buf))
...
public func FfiConverterTypeCapacityError_lift(_ buf: RustBuffer) throws -> CapacityError {
    return try FfiConverterTypeCapacityError.lift(buf)
}

public func FfiConverterTypeCapacityError_lower(_ value: CapacityError) -> RustBuffer {
    return FfiConverterTypeCapacityError.lower(value)
}
...
public struct FfiConverterTypeChannelError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ChannelError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return try .join(join: FfiConverterTypeChannelJoinError.read(from: &buf)
            )

        case 2: return try .cast(cast: FfiConverterTypeCastError.read(from: &buf)
            )

        case 3: return try .call(call: FfiConverterTypeCallError.read(from: &buf)
            )

        case 4: return try .leave(leave: FfiConverterTypeLeaveError.read(from: &buf)
            )

        case 5: return try .shutdown(shutdown: FfiConverterTypeChannelShutdownError.read(from: &buf)
            )
...
public func FfiConverterTypeChannelError_lift(_ buf: RustBuffer) throws -> ChannelError {
    return try FfiConverterTypeChannelError.lift(buf)
}

public func FfiConverterTypeChannelError_lower(_ value: ChannelError) -> RustBuffer {
    return FfiConverterTypeChannelError.lower(value)
}
...
extension ChannelJoinError: Error {}
...
extension ChannelShutdownError: Error {}
...
public struct FfiConverterTypeChannelStatusJoinError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ChannelStatusJoinError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return try .rejected(response: FfiConverterTypePayload.read(from: &buf)
            )
...
public func FfiConverterTypeChannelStatusJoinError_lift(_ buf: RustBuffer) throws -> ChannelStatusJoinError {
    return try FfiConverterTypeChannelStatusJoinError.lift(buf)
}

public func FfiConverterTypeChannelStatusJoinError_lower(_ value: ChannelStatusJoinError) -> RustBuffer {
    return FfiConverterTypeChannelStatusJoinError.lower(value)
}
...
extension DisconnectError: Error {}
...
public func FfiConverterTypeHTTParseError_lift(_ buf: RustBuffer) throws -> HttParseError {
    return try FfiConverterTypeHTTParseError.lift(buf)
}

public func FfiConverterTypeHTTParseError_lower(_ value: HttParseError) -> RustBuffer {
    return FfiConverterTypeHTTParseError.lower(value)
}
...
public struct FfiConverterTypeHttpError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> HttpError {
        ...
        case 3: return try .uri(invalidUri: FfiConverterString.read(from: &buf)
            )

        case 4: return try .uriParts(invalidUri: FfiConverterString.read(from: &buf)
            )
...
public func FfiConverterTypeInvalidUri_lift(_ buf: RustBuffer) throws -> InvalidUri {
    return try FfiConverterTypeInvalidUri.lift(buf)
}

public func FfiConverterTypeInvalidUri_lower(_ value: InvalidUri) -> RustBuffer {
    return FfiConverterTypeInvalidUri.lower(value)
}
...
public struct FfiConverterTypeJSONDeserializationError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> JsonDeserializationError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return try .io(line: FfiConverterUInt64.read(from: &buf), column: FfiConverterUInt64.read(from: &buf), ioError: FfiConverterTypeIoError.read(from: &buf))

        case 2: return try .syntax(line: FfiConverterUInt64.read(from: &buf), column: FfiConverterUInt64.read(from: &buf))

        case 3: return try .data(line: FfiConverterUInt64.read(from: &buf), column: FfiConverterUInt64.read(from: &buf))

        case 4: return try .eof(line: FfiConverterUInt64.read(from: &buf), column: FfiConverterUInt64.read(from: &buf))
...
public func FfiConverterTypeJSONDeserializationError_lift(_ buf: RustBuffer) throws -> JsonDeserializationError {
    return try FfiConverterTypeJSONDeserializationError.lift(buf)
}

public func FfiConverterTypeJSONDeserializationError_lower(_ value: JsonDeserializationError) -> RustBuffer {
    return FfiConverterTypeJSONDeserializationError.lower(value)
}
...
public struct FfiConverterTypePhoenixError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PhoenixError {
        ...
        case 2: return try .urlParse(urlParse: FfiConverterTypeURLParseError.read(from: &buf)
            )

        case 3: return try .socket(socket: FfiConverterTypeSocketError.read(from: &buf)
            )

        case 4: return try .channel(channel: FfiConverterTypeChannelError.read(from: &buf)
            )

        case 5: return try .statuses(statuses: FfiConverterTypeStatusesError.read(from: &buf)
            )
...
public func FfiConverterTypePhoenixError_lift(_ buf: RustBuffer) throws -> PhoenixError {
    return try FfiConverterTypePhoenixError.lift(buf)
}

public func FfiConverterTypePhoenixError_lower(_ value: PhoenixError) -> RustBuffer {
    return FfiConverterTypePhoenixError.lower(value)
}
...
public struct FfiConverterTypeProtocolError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ProtocolError {
        ...
        case 10: return try .invalidHeader(header: FfiConverterString.read(from: &buf)
            )

        case 11: return .handshakeIncomplete

        case 12: return try .httparseError(httparseError: FfiConverterTypeHTTParseError.read(from: &buf)
            )
        ...
        case 20: return try .unknownControlFrameType(controlFrameType: FfiConverterUInt8.read(from: &buf)
            )

        case 21: return try .unknownDataFrameType(dataFrameType: FfiConverterUInt8.read(from: &buf)
            )

        case 22: return .unexpectedContinueFrame

        case 23: return try .expectedFragment(data: FfiConverterTypeTungsteniteData.read(from: &buf)
            )

        case 24: return .resetWithoutClosingHandshake

        case 25: return try .invalidOpcode(opcode: FfiConverterUInt8.read(from: &buf)
            )
...
extension SocketChannelError: Error {}
...
public struct FfiConverterTypeSocketError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SocketError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return try .spawn(spawnError: FfiConverterTypeSpawnError.read(from: &buf)
            )

        case 2: return try .connect(connectError: FfiConverterTypeConnectError.read(from: &buf)
            )

        case 3: return try .channel(channelError: FfiConverterTypeSocketChannelError.read(from: &buf)
            )

        case 4: return try .disconnect(disconnectError: FfiConverterTypeDisconnectError.read(from: &buf)
            )

        case 5: return try .shutdown(shutdownError: FfiConverterTypeSocketShutdownError.read(from: &buf)
            )
...
public func FfiConverterTypeSocketError_lift(_ buf: RustBuffer) throws -> SocketError {
    return try FfiConverterTypeSocketError.lift(buf)
}

public func FfiConverterTypeSocketError_lower(_ value: SocketError) -> RustBuffer {
    return FfiConverterTypeSocketError.lower(value)
}
...
extension SocketShutdownError: Error {}
...
public func FfiConverterTypeURLParseError_lift(_ buf: RustBuffer) throws -> UrlParseError {
    return try FfiConverterTypeURLParseError.lift(buf)
}

public func FfiConverterTypeURLParseError_lower(_ value: UrlParseError) -> RustBuffer {
    return FfiConverterTypeURLParseError.lower(value)
}
...
public struct FfiConverterTypeWebSocketError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> WebSocketError {
        ...
        case 3: return try .io(ioError: FfiConverterTypeIoError.read(from: &buf)
            )

        case 4: return try .tls(tlsError: FfiConverterString.read(from: &buf)
            )

        case 5: return try .capacity(capacityError: FfiConverterTypeCapacityError.read(from: &buf)
            )

        case 6: return try .protocol(protocolError: FfiConverterTypeProtocolError.read(from: &buf)
            )

        case 7: return try .writeBufferFull(msg: FfiConverterTypeWebSocketMessage.read(from: &buf)
            )
        ...
        case 10: return try .url(urlError: FfiConverterString.read(from: &buf)
            )

        case 11: return try .http(response: FfiConverterTypeResponse.read(from: &buf)
            )

        case 12: return try .httpFormat(error: FfiConverterTypeHttpError.read(from: &buf)
            )
...
public func FfiConverterTypeWebSocketError_lift(_ buf: RustBuffer) throws -> WebSocketError {
    return try FfiConverterTypeWebSocketError.lift(buf)
}

public func FfiConverterTypeWebSocketError_lower(_ value: WebSocketError) -> RustBuffer {
    return FfiConverterTypeWebSocketError.lower(value)
}
