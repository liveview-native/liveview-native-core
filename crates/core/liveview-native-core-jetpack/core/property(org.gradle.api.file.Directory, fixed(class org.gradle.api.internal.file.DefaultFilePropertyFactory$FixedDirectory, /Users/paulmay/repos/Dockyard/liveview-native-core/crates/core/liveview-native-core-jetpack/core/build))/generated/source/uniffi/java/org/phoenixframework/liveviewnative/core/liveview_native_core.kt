...
internal interface UniffiCallbackInterfaceNavEventHandlerMethod0 : com.sun.jna.Callback {
    fun callback(
        `uniffiHandle`: Long,
...
@Structure.FieldOrder("handleEvent", "uniffiFree")
internal open class UniffiVTableCallbackInterfaceNavEventHandler(
    @JvmField internal var `handleEvent`: UniffiCallbackInterfaceNavEventHandlerMethod0? = null,
    @JvmField internal var `uniffiFree`: UniffiCallbackInterfaceFree? = null,
) : Structure() {
    class UniffiByValue(
        `handleEvent`: UniffiCallbackInterfaceNavEventHandlerMethod0? = null,
        `uniffiFree`: UniffiCallbackInterfaceFree? = null,
    ) : UniffiVTableCallbackInterfaceNavEventHandler(`handleEvent`, `uniffiFree`),
        Structure.ByValue

    internal fun uniffiSetValue(other: UniffiVTableCallbackInterfaceNavEventHandler) {
        `handleEvent` = other.`handleEvent`
        `uniffiFree` = other.`uniffiFree`
    }
}
...
internal interface UniffiLib : Library {
        ...
        internal val INSTANCE: UniffiLib by lazy {
            loadIndirect<UniffiLib>(componentName = "liveview_native_core")
                .also { lib: UniffiLib ->
                    ...
                    uniffiCallbackInterfaceNavEventHandler.register(lib)
                }
        }
    ...
    fun uniffi_liveview_native_core_fn_method_livesocket_back(
        `ptr`: Pointer,
        `info`: RustBuffer.ByValue,
    ): Long

    fun uniffi_liveview_native_core_fn_method_livesocket_can_go_back(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Byte

    fun uniffi_liveview_native_core_fn_method_livesocket_can_go_forward(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Byte

    fun uniffi_liveview_native_core_fn_method_livesocket_can_traverse_to(
        `ptr`: Pointer,
        `id`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Byte

    fun uniffi_liveview_native_core_fn_method_livesocket_current(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue
    ...
    fun uniffi_liveview_native_core_fn_method_livesocket_forward(
        `ptr`: Pointer,
        `info`: RustBuffer.ByValue,
    ): Long

    fun uniffi_liveview_native_core_fn_method_livesocket_get_entries(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue
    ...
    fun uniffi_liveview_native_core_fn_method_livesocket_navigate(
        `ptr`: Pointer,
        `url`: RustBuffer.ByValue,
        `opts`: RustBuffer.ByValue,
    ): Long

    fun uniffi_liveview_native_core_fn_method_livesocket_reload(
        `ptr`: Pointer,
        `info`: RustBuffer.ByValue,
    ): Long

    fun uniffi_liveview_native_core_fn_method_livesocket_set_event_handler(
        `ptr`: Pointer,
        `handler`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit
    ...
    fun uniffi_liveview_native_core_fn_method_livesocket_timeout(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun uniffi_liveview_native_core_fn_method_livesocket_traverse_to(
        `ptr`: Pointer,
        `id`: Long,
        `info`: RustBuffer.ByValue,
    ): Long
    ...
    fun uniffi_liveview_native_core_fn_init_callback_vtable_naveventhandler(`vtable`: UniffiVTableCallbackInterfaceNavEventHandler): Unit
    ...
    fun uniffi_liveview_native_core_checksum_method_livesocket_back(): Short

    fun uniffi_liveview_native_core_checksum_method_livesocket_can_go_back(): Short

    fun uniffi_liveview_native_core_checksum_method_livesocket_can_go_forward(): Short

    fun uniffi_liveview_native_core_checksum_method_livesocket_can_traverse_to(): Short

    fun uniffi_liveview_native_core_checksum_method_livesocket_current(): Short

    fun uniffi_liveview_native_core_checksum_method_livesocket_dead_render(): Short

    fun uniffi_liveview_native_core_checksum_method_livesocket_forward(): Short

    fun uniffi_liveview_native_core_checksum_method_livesocket_get_entries(): Short
    ...
    fun uniffi_liveview_native_core_checksum_method_livesocket_navigate(): Short

    fun uniffi_liveview_native_core_checksum_method_livesocket_reload(): Short

    fun uniffi_liveview_native_core_checksum_method_livesocket_set_event_handler(): Short
    ...
    fun uniffi_liveview_native_core_checksum_method_livesocket_timeout(): Short

    fun uniffi_liveview_native_core_checksum_method_livesocket_traverse_to(): Short
    ...
    fun uniffi_liveview_native_core_checksum_method_naveventhandler_handle_event(): Short
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    ...
    if (lib.uniffi_liveview_native_core_checksum_method_livechannel_merge_diffs() != 47482.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_liveview_native_core_checksum_method_livesocket_back() != 1612.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_liveview_native_core_checksum_method_livesocket_can_go_back() != 20232.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_liveview_native_core_checksum_method_livesocket_can_go_forward() != 26425.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_liveview_native_core_checksum_method_livesocket_can_traverse_to() != 28194.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_liveview_native_core_checksum_method_livesocket_current() != 56296.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_liveview_native_core_checksum_method_livesocket_dead_render() != 35094.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_liveview_native_core_checksum_method_livesocket_forward() != 50776.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_liveview_native_core_checksum_method_livesocket_get_entries() != 26817.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_liveview_native_core_checksum_method_livesocket_navigate() != 303.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_liveview_native_core_checksum_method_livesocket_reload() != 25122.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_liveview_native_core_checksum_method_livesocket_set_event_handler() != 47419.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_liveview_native_core_checksum_method_livesocket_timeout() != 28451.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_liveview_native_core_checksum_method_livesocket_traverse_to() != 45994.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_liveview_native_core_checksum_method_naveventhandler_handle_event() != 8593.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
...
public interface LiveSocketInterface {
    suspend fun `back`(`info`: kotlin.ByteArray?): kotlin.ULong
    ...
    suspend fun `reload`(`info`: kotlin.ByteArray?): kotlin.ULong

    /**
     * Sets the handler for navigation events.
     */
    fun `setEventHandler`(`handler`: NavEventHandler)
    ...
    suspend fun `traverseTo`(
        `id`: kotlin.ULong,
        `info`: kotlin.ByteArray?,
    ): kotlin.ULong
...
open class LiveSocket :
    ...
    @Throws(LiveSocketException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `back`(`info`: kotlin.ByteArray?): kotlin.ULong =
        uniffiRustCallAsync(
            callWithPointer { thisPtr ->
                UniffiLib.INSTANCE.uniffi_liveview_native_core_fn_method_livesocket_back(
                    thisPtr,
                    FfiConverterOptionalByteArray.lower(`info`),
                )
            },
            {
                future,
                ...
                continuation,
                ->
                UniffiLib.INSTANCE.ffi_liveview_native_core_rust_future_poll_u64(future, callback, continuation)
            },
            { future, continuation -> UniffiLib.INSTANCE.ffi_liveview_native_core_rust_future_complete_u64(future, continuation) },
            { future -> UniffiLib.INSTANCE.ffi_liveview_native_core_rust_future_free_u64(future) },
            // lift function
    ...
    override fun `canGoBack`(): kotlin.Boolean =
        FfiConverterBoolean.lift(
            callWithPointer {
                uniffiRustCall { _status ->
                    UniffiLib.INSTANCE.uniffi_liveview_native_core_fn_method_livesocket_can_go_back(
                        it,
                        _status,
                    )
                }
     ...
     * Returns whether navigation forward in history is possible.
     */
    override fun `canGoForward`(): kotlin.Boolean =
        FfiConverterBoolean.lift(
            callWithPointer {
                uniffiRustCall { _status ->
                    UniffiLib.INSTANCE.uniffi_liveview_native_core_fn_method_livesocket_can_go_forward(
                        it,
                        _status,
                    )
                }
     ...
     * Returns whether navigation to the specified history entry ID is possible.
     */
    override fun `canTraverseTo`(`id`: kotlin.ULong): kotlin.Boolean =
        FfiConverterBoolean.lift(
            callWithPointer {
                uniffiRustCall { _status ->
                    UniffiLib.INSTANCE.uniffi_liveview_native_core_fn_method_livesocket_can_traverse_to(
                        it,
     ...
     * Returns the current history entry, if one exists.
     */
    override fun `current`(): NavHistoryEntry? =
        FfiConverterOptionalTypeNavHistoryEntry.lift(
            callWithPointer {
                uniffiRustCall { _status ->
                    UniffiLib.INSTANCE.uniffi_liveview_native_core_fn_method_livesocket_current(
                        it,
                        _status,
                    )
                }
    ...
    @Throws(LiveSocketException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `forward`(`info`: kotlin.ByteArray?): kotlin.ULong =
        uniffiRustCallAsync(
            callWithPointer { thisPtr ->
                UniffiLib.INSTANCE.uniffi_liveview_native_core_fn_method_livesocket_forward(
                    thisPtr,
                    FfiConverterOptionalByteArray.lower(`info`),
                )
            },
     ...
     * Returns a list of all history entries in traversal sequence order.
     */
    override fun `getEntries`(): List<NavHistoryEntry> =
        FfiConverterSequenceTypeNavHistoryEntry.lift(
            callWithPointer {
                uniffiRustCall { _status ->
                    UniffiLib.INSTANCE.uniffi_liveview_native_core_fn_method_livesocket_get_entries(
                        it,
                        _status,
                    )
                }
    ...
    override suspend fun `navigate`(
        ...
        uniffiRustCallAsync(
            callWithPointer { thisPtr ->
                UniffiLib.INSTANCE.uniffi_liveview_native_core_fn_method_livesocket_navigate(
                    thisPtr,
                    FfiConverterString.lower(`url`),
                    FfiConverterTypeNavOptions.lower(`opts`),
                )
            },
            {
                future,
    ...
    @Throws(LiveSocketException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `reload`(`info`: kotlin.ByteArray?): kotlin.ULong =
        uniffiRustCallAsync(
            callWithPointer { thisPtr ->
                UniffiLib.INSTANCE.uniffi_liveview_native_core_fn_method_livesocket_reload(
                    thisPtr,
                    FfiConverterOptionalByteArray.lower(`info`),
                )
            },
     ...
     * Sets the handler for navigation events.
     */
    override fun `setEventHandler`(`handler`: NavEventHandler) =
        callWithPointer {
            uniffiRustCall { _status ->
                UniffiLib.INSTANCE.uniffi_liveview_native_core_fn_method_livesocket_set_event_handler(
                    it,
                    FfiConverterTypeNavEventHandler.lower(`handler`),
                    _status,
                )
            }
        }
    ...
    override fun `timeout`(): java.time.Duration =
        FfiConverterDuration.lift(
            callWithPointer {
                uniffiRustCall { _status ->
                    UniffiLib.INSTANCE.uniffi_liveview_native_core_fn_method_livesocket_timeout(
                        it,
                        _status,
                    )
                }
    ...
    @Throws(LiveSocketException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `traverseTo`(
        `id`: kotlin.ULong,
        `info`: kotlin.ByteArray?,
    ): kotlin.ULong =
        uniffiRustCallAsync(
            callWithPointer { thisPtr ->
                UniffiLib.INSTANCE.uniffi_liveview_native_core_fn_method_livesocket_traverse_to(
                    thisPtr,
                    FfiConverterULong.lower(`id`),
                    FfiConverterOptionalByteArray.lower(`info`),
                )
 ...
 * @suppress
 */
public object FfiConverterTypeNavEvent : FfiConverterRustBuffer<NavEvent> {
    override fun read(buf: ByteBuffer): NavEvent =
        NavEvent(
            FfiConverterTypeNavEventType.read(buf),
            FfiConverterBoolean.read(buf),
            FfiConverterOptionalTypeNavHistoryEntry.read(buf),
            FfiConverterTypeNavHistoryEntry.read(buf),
            FfiConverterOptionalByteArray.read(buf),
        )

    override fun allocationSize(value: NavEvent) =
        (
            FfiConverterTypeNavEventType.allocationSize(value.`event`) +
                FfiConverterBoolean.allocationSize(value.`sameDocument`) +
                FfiConverterOptionalTypeNavHistoryEntry.allocationSize(value.`from`) +
                FfiConverterTypeNavHistoryEntry.allocationSize(value.`to`) +
                FfiConverterOptionalByteArray.allocationSize(value.`info`)
        )
    ...
    override fun write(
        ...
        FfiConverterTypeNavEventType.write(value.`event`, buf)
        FfiConverterBoolean.write(value.`sameDocument`, buf)
        FfiConverterOptionalTypeNavHistoryEntry.write(value.`from`, buf)
        FfiConverterTypeNavHistoryEntry.write(value.`to`, buf)
        FfiConverterOptionalByteArray.write(value.`info`, buf)
    }
}
 ...
 * @suppress
 */
public object FfiConverterTypeNavHistoryEntry : FfiConverterRustBuffer<NavHistoryEntry> {
    override fun read(buf: ByteBuffer): NavHistoryEntry =
        NavHistoryEntry(
            FfiConverterString.read(buf),
            FfiConverterULong.read(buf),
            FfiConverterOptionalByteArray.read(buf),
    ...
    override fun allocationSize(value: NavHistoryEntry) =
        (
...
data class NavOptions(
    ...
    var `extraEventInfo`: kotlin.ByteArray? = null,
    var `state`: kotlin.ByteArray? = null,
) {
    companion object
}
 ...
 * @suppress
 */
public object FfiConverterTypeNavOptions : FfiConverterRustBuffer<NavOptions> {
    override fun read(buf: ByteBuffer): NavOptions =
        NavOptions(
            FfiConverterOptionalTypeNavAction.read(buf),
            FfiConverterOptionalByteArray.read(buf),
            FfiConverterOptionalByteArray.read(buf),
        )

    override fun allocationSize(value: NavOptions) =
        (
            FfiConverterOptionalTypeNavAction.allocationSize(value.`action`) +
                FfiConverterOptionalByteArray.allocationSize(value.`extraEventInfo`) +
                FfiConverterOptionalByteArray.allocationSize(value.`state`)
        )
    ...
    override fun write(
        ...
        FfiConverterOptionalTypeNavAction.write(value.`action`, buf)
        FfiConverterOptionalByteArray.write(value.`extraEventInfo`, buf)
        FfiConverterOptionalByteArray.write(value.`state`, buf)
    }
}
 ...
 * @suppress
 */
public object FfiConverterTypeHandlerResponse : FfiConverterRustBuffer<HandlerResponse> {
    override fun read(buf: ByteBuffer) =
        try {
            HandlerResponse.values()[buf.getInt() - 1]
        } catch (e: IndexOutOfBoundsException) {
            throw RuntimeException("invalid enum value, something is very wrong!!", e)
        }

    override fun allocationSize(value: HandlerResponse) = 4UL
...
sealed class LiveSocketException : kotlin.Exception() {
    class DisconnectionException : LiveSocketException() {
        override val message
            get() = ""
    }

    class NavigationImpossible : LiveSocketException() {
        override val message
            get() = ""
    }
...
public object FfiConverterTypeLiveSocketError : FfiConverterRustBuffer<LiveSocketException> {
    override fun read(buf: ByteBuffer): LiveSocketException =
        when (buf.getInt()) {
            1 -> LiveSocketException.DisconnectionException()
            2 -> LiveSocketException.NavigationImpossible()
            3 -> LiveSocketException.PayloadNotJson()
            4 ->
            ...
            11 -> LiveSocketException.CsfrTokenMissing()
            12 -> LiveSocketException.PhoenixIdMissing()
            13 ->
                LiveSocketException.ConnectionException(
                    FfiConverterString.read(buf),
                )
            14 -> LiveSocketException.PhoenixSessionMissing()
            15 -> LiveSocketException.PhoenixStaticMissing()
            16 -> LiveSocketException.PhoenixMainMissing()
            17 -> LiveSocketException.NoHostInUrl()
            18 -> LiveSocketException.NoUploadToken()
            19 -> LiveSocketException.NoLiveReloadUrl()
            20 ->
            ...
            22 -> LiveSocketException.NoDocumentInJoinPayload()
            23 ->
            ...
            25 -> LiveSocketException.NoInputRefInDocument()
            26 ->
    ...
    override fun allocationSize(value: LiveSocketException): ULong =
        when (value) {
            is LiveSocketException.DisconnectionException -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is LiveSocketException.NavigationImpossible -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            ...
            is LiveSocketException.ConnectionException -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL +
...
sealed class MergeException : kotlin.Exception() {
    class UnresolvedComponent : MergeException() {
        override val message
            get() = ""
    }
...
public object FfiConverterTypeMergeError : FfiConverterRustBuffer<MergeException> {
    override fun read(buf: ByteBuffer): MergeException =
        when (buf.getInt()) {
            1 -> MergeException.UnresolvedComponent()
            2 ->
                MergeException.MissingComponent(
                    FfiConverterInt.read(buf),
                )
            3 -> MergeException.FragmentTypeMismatch()
            4 -> MergeException.CreateComponentFromUpdate()
            5 -> MergeException.CreateChildFromUpdateFragment()
            6 -> MergeException.AddChildToExisting()
            7 -> MergeException.StreamIdMismatch()
            8 ->
    ...
    override fun allocationSize(value: MergeException): ULong =
        when (value) {
            is MergeException.UnresolvedComponent -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is MergeException.MissingComponent -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL +
 ...
 * @suppress
 */
public object FfiConverterTypeNavAction : FfiConverterRustBuffer<NavAction> {
    override fun read(buf: ByteBuffer) =
        try {
            NavAction.values()[buf.getInt() - 1]
        } catch (e: IndexOutOfBoundsException) {
            throw RuntimeException("invalid enum value, something is very wrong!!", e)
        }

    override fun allocationSize(value: NavAction) = 4UL
 ...
 * @suppress
 */
public object FfiConverterTypeNavEventType : FfiConverterRustBuffer<NavEventType> {
    override fun read(buf: ByteBuffer) =
        try {
            NavEventType.values()[buf.getInt() - 1]
        } catch (e: IndexOutOfBoundsException) {
            throw RuntimeException("invalid enum value, something is very wrong!!", e)
        }

    override fun allocationSize(value: NavEventType) = 4UL
...
public interface NavEventHandler {
     ...
     */
    fun `handleEvent`(`event`: NavEvent): HandlerResponse

    companion object
}

// Put the implementation in an object so we don't pollute the top-level namespace
internal object uniffiCallbackInterfaceNavEventHandler {
    internal object `handleEvent` : UniffiCallbackInterfaceNavEventHandlerMethod0 {
        override fun callback(
            `uniffiHandle`: Long,
            `event`: RustBuffer.ByValue,
            `uniffiOutReturn`: RustBuffer,
            ...
            val uniffiObj = FfiConverterTypeNavEventHandler.handleMap.get(uniffiHandle)
            val makeCall = {  uniffiObj.`handleEvent`(
                FfiConverterTypeNavEvent.lift(`event`),
            )
            }
            val writeReturn = { value: HandlerResponse -> uniffiOutReturn.setValue(FfiConverterTypeHandlerResponse.lower(value)) }
            uniffiTraitInterfaceCall(uniffiCallStatus, makeCall, writeReturn)
        }
    }
    ...
    internal object uniffiFree : UniffiCallbackInterfaceFree {
        override fun callback(handle: Long) {
            FfiConverterTypeNavEventHandler.handleMap.remove(handle)
        }
    }

    internal var vtable =
        UniffiVTableCallbackInterfaceNavEventHandler.UniffiByValue(
            `handleEvent`,
            uniffiFree,
        )
    ...
    // This method is generated for each callback interface.
    internal fun register(lib: UniffiLib) {
        lib.uniffi_liveview_native_core_fn_init_callback_vtable_naveventhandler(vtable)
    }
}
 ...
 * @suppress
 */
public object FfiConverterTypeNavEventHandler : FfiConverterCallbackInterface<NavEventHandler>()
 ...
 * @suppress
 */
public object FfiConverterOptionalTypeNavHistoryEntry : FfiConverterRustBuffer<NavHistoryEntry?> {
    override fun read(buf: ByteBuffer): NavHistoryEntry? {
        if (buf.get().toInt() == 0) {
            return null
        }
        return FfiConverterTypeNavHistoryEntry.read(buf)
    }

    override fun allocationSize(value: NavHistoryEntry?): ULong {
        if (value == null) {
            return 1UL
        } else {
            return 1UL + FfiConverterTypeNavHistoryEntry.allocationSize(value)
        }
    }
    ...
    override fun write(
        ...
        if (value == null) {
            ...
            buf.put(1)
            FfiConverterTypeNavHistoryEntry.write(value, buf)
        }
    }
}
 ...
 * @suppress
 */
public object FfiConverterOptionalTypeNavAction : FfiConverterRustBuffer<NavAction?> {
    override fun read(buf: ByteBuffer): NavAction? {
        if (buf.get().toInt() == 0) {
            return null
        }
        return FfiConverterTypeNavAction.read(buf)
    }

    override fun allocationSize(value: NavAction?): ULong {
        if (value == null) {
            return 1UL
        } else {
            return 1UL + FfiConverterTypeNavAction.allocationSize(value)
        }
    }
    ...
    override fun write(
        ...
        if (value == null) {
            ...
            buf.put(1)
            FfiConverterTypeNavAction.write(value, buf)
        }
    }
}
 ...
 * @suppress
 */
public object FfiConverterSequenceTypeNavHistoryEntry : FfiConverterRustBuffer<List<NavHistoryEntry>> {
    override fun read(buf: ByteBuffer): List<NavHistoryEntry> {
        val len = buf.getInt()
        return List<NavHistoryEntry>(len) {
            FfiConverterTypeNavHistoryEntry.read(buf)
        }
    }

    override fun allocationSize(value: List<NavHistoryEntry>): ULong {
        val sizeForLength = 4UL
        val sizeForItems = value.map { FfiConverterTypeNavHistoryEntry.allocationSize(it) }.sum()
        return sizeForLength + sizeForItems
    }

    override fun write(
        value: List<NavHistoryEntry>,
        buf: ByteBuffer,
    ) {
        buf.putInt(value.size)
        value.iterator().forEach {
            FfiConverterTypeNavHistoryEntry.write(it, buf)
        }
    }
}
